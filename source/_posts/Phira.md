---
title: 【入坑指南】Phira完整入坑指南！
date: 2025-05-20 21:46:33
top:
cover: /LimePan/Phira/cover.webp
categories: 教程
description: 本文章提供了Phira的下载地址，以及完整的Phira游玩教程！这绝对是你入坑Phira的必要说明书！
hidden:
tags:
- Phira
- Phigros
...
>该应用支持Windows, Android, iOS, MacOS, 甚至Linux！？该篇目篇幅有限，只写了安卓端的下载教程，软件内的使用方法通用。
...
[点我](https://github.com/TeamFlos/phira/releases/)跳转至下载页面，跳转后选择与自己设备相符的版本下载即可（iOS需要签名后安装）
...
![首次进入Phira预览](/LimePan/Phira/mainmenu-not-login.webp)<br>

>点击右上角的头像按钮

![登陆界面预览](/LimePan/Phira/Signin.webp)<br>

>点击下方注册按钮，填写你的邮箱和你要注册的账号密码，密码满足8位有英文数字就行。

>之后打开你的邮箱，查看邮件，如果收件箱没有可以在垃圾邮件里查看Phira的注册验证邮件
...
![上架](/LimePan/Phira/putaway.webp)<br>

![未上架](/LimePan/Phira/not_putaway.webp)<br>
...
![资源包](/LimePan/Phira/respack.webp)<br>
...
![本地谱面](/LimePan/Phira/local.webp)<br>
...
>Re':'PhiEdit，简称RPE，是由cmdysj开发的Phigros谱面制作软件。

这是一款非常强大的自制谱制作器，你可以通过Wiki页面的下载链接下载
<br>
...
[点我出发-Github](https://github.com/cbs001/open-phiedit/releases/tag/windows)
